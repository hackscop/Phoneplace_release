(function() {
    ...
    // PUT YOUR RENDER API LINK HERE - DO NOT FORGET TO UPDATE THIS
    ...
    async function sendMessage() {
        ...
        try {
            ...
            var isTransfer = formattedReply.includes("wa-btn");
            var label = isTransfer ? "System" : "PhonePlace";
            
            // DYNAMIC HEADER SWITCH
            var headerEl = document.getElementById('ai-chat-header');
            var titleEl = document.getElementById('ai-chat-title');
            if(isTransfer) {
                headerEl.style.background = '#1c1c1e';
                titleEl.innerText = 'Live Agent Transfer';
            } else {
                headerEl.style.background = '#25D366';
                titleEl.innerText = 'PhonePlace Support';
            }
